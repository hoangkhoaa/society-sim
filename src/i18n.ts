...
const translations = {
  en: {
    ...
    'setup.preset_nordic': '🏔 Nordic social democracy',
    'setup.preset_cap':    '💹 Liberal market economy',
    'setup.preset_soc':    '🏭 Centrally planned economy',
    'setup.preset_feudal':      '⚔️ Feudal political order',
    'setup.preset_theocracy':   '⛪ Theocratic governance',
    'setup.preset_technocracy': '🧠 Technocratic governance',
    'setup.preset_warlord':     '🗡 Fragmented warlord rule',
    'setup.preset_commune':     '🌿 Egalitarian communal society',
    'setup.preset_marxist':     '🟥 State-planned economy',
    ...
    'econ.exports':     'Exports',
    'econ.imports':     'Imports',
    'econ.trade_balance': 'Trade Balance',
    'econ.trade_revenue': 'Trade Revenue',
    'econ.money_supply': 'Money Supply',
    'econ.inflation':   'Inflation',
    'econ.money_printed': 'Money Printed',
    'econ.sanitation':  'Sanitation',
    'econ.hospital':    'Hospital',
    'econ.total_taxes': 'Total Taxes',
    'econ.total_printed': 'Total Printed',
    'econ.total_exports': 'Total Exports',
    'econ.total_imports': 'Total Imports',
    'econ.total_trade_rev': 'Trade Revenue Σ',
    ...
    'econ.tip_exports':    'Daily export value generated by domestic production and trade capacity.',
    'econ.tip_imports':    'Daily import value paid to external markets to cover domestic shortages.',
    'econ.tip_trade_balance': 'Exports minus imports. Positive means net money inflow from outside.',
    'econ.tip_trade_revenue': 'Treasury revenue from export duties, import tariffs, and trade settlement effects.',
    'econ.tip_money_supply': 'Total nominal money circulating in the society (private wealth + treasury).',
    'econ.tip_inflation':  'Cumulative inflation pressure. Higher inflation increases cost of living over time.',
    'econ.tip_money_printed': 'Emergency money printed by the state today to prevent treasury collapse.',
    'econ.tip_sanitation': 'Public sanitation quality (0-100). Falls naturally, improved by health/science capacity.',
    'econ.tip_hospital':   'Hospital service status. Active only while health infrastructure is funded.',
    'econ.tip_total_taxes': 'Cumulative taxes collected since the start (income tax, redistribution levies, tribute-like extraction).',
    'econ.tip_total_printed': 'Total emergency money created by the state across the whole run.',
    'econ.tip_total_exports': 'Cumulative export value since game start.',
    'econ.tip_total_imports': 'Cumulative import value since game start.',
    'econ.tip_total_trade_rev': 'Cumulative net state revenue from duties/tariffs and trade settlement.',
    ...
    // Chat
    'chat.ph': 'Talk to the world... ("create a storm", "a good harvest,...")',
    'chat.disabled': 'AI chat disabled — running without API key',
    'chat.ph_no_api': 'Try: epidemic, drought, storm, festival...',
    ...
    'qa.hospital.title': 'Build hospital',
    'qa.harvest.title':  'Farm subsidy',
    'qa.martial.title':  'Martial law',
    'qa.propa.title':    'Propaganda',
    'qa.tax.title':      'Tax cut',
    'qa.not_enough':     '— not enough funds',
    'qa.feed':           'Action: {label}',

    // Factions panel
    'factions.section':       'FACTIONS',
    'factions.none':          'No factions yet',
    'factions.support':       'Support 80💰',
    'factions.suppress':      'Suppress',
    'factions.feed_support':  'Supported faction {name} ({count} members)',
    ...
    // Objective labels & rewards
    'obj.food.label':     'Sustain food > 50% for 20 days',
    'obj.food.reward':    '+150 coins treasury',
    'obj.trust.label':    'Raise trust to 40% (now {val}%)',
    'obj.trust.reward':   'Government legitimacy +10%',
    'obj.gini.label':     'Keep Gini below 0.70 for 15 days',
    'obj.gini.reward':    'Market trust +10%',
    'obj.pressure.label': 'Reduce political pressure to 30% (now {val}%)',
    'obj.pressure.reward':'Stability +5',
    'obj.literacy.label': 'Reach literacy 20 (add scholars)',
    'obj.literacy.reward':'Research +200 points',

    // Crisis cards
    'crisis.food.title':  '⚠️ Famine Imminent',
    'crisis.food.body':   'Food supply at {food}%. Citizens are desperate.',
    'crisis.food.opt_a':  '🍞 Distribute rations (food +10, grievance −)',
    'crisis.food.opt_b':  '🛒 Emergency purchase (−200 coins, food +20)',
    'crisis.food.opt_c':  '😐 Ignore (grievance +15)',
    'crisis.epidemic.title':  '🦠 Epidemic Spreading',
    'crisis.epidemic.body':   'Epidemic has lasted more than 3 days. Immediate action needed.',
    'crisis.epidemic.opt_a':  '🚧 Quarantine zones',
    'crisis.epidemic.opt_b':  '🏥 Invest in healthcare (−200 coins, open hospital)',
    'crisis.epidemic.opt_c':  '🙏 Ignore (fear increases)',
    'crisis.strike.title':  '✊ Strike Imminent',
    'crisis.strike.body':   'Labour solidarity {unrest}%, grievance {griev}%. Workers are preparing to strike.',
    'crisis.strike.opt_a':  '🤝 Negotiate (safety_net +0.05, solidarity −20)',
    'crisis.strike.opt_b':  '⚔️ Suppress (fear +20, solidarity −30)',
    'crisis.strike.opt_c':  '🤷 Ignore (strike occurs)',
    'crisis.class.title':   '⚖️ Class Unrest',
    'crisis.class.body':    'Gini inequality {gini}, stability {stability}%. Society is fracturing.',
    'crisis.class.opt_a':   '💸 Redistribute (tax the rich, give to the poor)',
    'crisis.class.opt_b':   '📣 Propaganda (grievance −15, legitimacy +8%)',
    'crisis.class.opt_c':   '🛡️ Tighten control (guard power +0.2)',
    'crisis.trust.title':   '😤 Trust Crisis',
    'crisis.trust.body':    'Government trust at {trust}%. Regime is losing legitimacy.',
    'crisis.trust.opt_a':   '📜 Transparency reforms (legitimacy +15%)',
    'crisis.trust.opt_b':   '📺 State media (seed rumor: trust_up)',
    'crisis.trust.opt_c':   '🗳️ Early elections (trigger referendum)',
    'crisis.trust.rumor':   'Government is working hard for the people',
    'crisis.trust.referendum': 'Increase welfare to restore trust',

    // Speed warning + no-API chat events
    'speed.ai_warning': '⚡ Speed {speed}× — AI will call ~{rpm} req/min. Consider disabling some AI features in Settings.',
    'noapi.epidemic':   'Epidemic breaks out across multiple regions.',
    'noapi.drought':    'Prolonged drought is reducing harvests.',
    'noapi.storm':      'A great storm strikes the land.',
    'noapi.festival':   'Festival begins, citizen morale rises.',
    'noapi.harvest':    'Bumper harvest — grain stores are full.',
    'noapi.scandal':    'Corruption news spreads, trust falls sharply.',
    'noapi.refugee':    'A wave of migrants arrives in the land.',
    'noapi.resource_boom': 'New resource deposit found — economy brightens.',
    'noapi.fallback':   '[No-AI mode] Try: "epidemic", "drought", "storm", "festival", "harvest", "scandal", "refugee", "resource boom"',
    ...
    'sp.thought_local.title': 'Generated locally (AI off)',
    'sp.thought.season.spring': 'spring',
    'sp.thought.season.summer': 'summer',
    'sp.thought.season.fall':   'fall',
    'sp.thought.season.winter': 'winter',
    'sp.thought.hunger': [
      "My stomach is so empty...",
      "It's been so long since I had a proper meal.",
      "It's {season} season and food is still scarce.",
    ] as const,
    'sp.thought.fear': [
      "I dare not go outside... it's too dangerous.",
      "I heard something big is happening outside.",
      "Where has everyone gone to hide?",
    ] as const,
    'sp.thought.grievance': [
      "I've worked my whole life and still can't get ahead.",
      "The rich keep getting richer and workers like me...",
      "The government doesn't care about us.",
    ] as const,
    'sp.thought.solidarity': [
      "We need to unite to make real change.",
      "One person alone can't do anything, but together...",
      "The workers are already talking about a strike.",
    ] as const,
    'sp.thought.exhaustion': [
      "So tired... working so much but nothing gets better.",
      "The burden is too heavy.",
      "My body can't take it anymore.",
    ] as const,
    'sp.thought.stress': [
      "Everything is too overwhelming, I don't know how long I can hold on.",
      "I couldn't sleep last night.",
      "The situation isn't stable at all.",
    ] as const,
    'sp.thought.happy': [
      "Life feels peaceful.",
      "I've saved up a bit — feeling more at ease.",
      "Today is a good day.",
    ] as const,
    'sp.thought.role.farmer':     ["I wonder what the weather will be like today — how are the crops doing?", "Have to plow early to make the harvest.", "This land is always the same year after year..."] as const,
    'sp.thought.role.craftsman':  ["Will today's orders be many or few?", "Skill only comes with constant practice.", "The workshop is so noisy today."] as const,
    'sp.thought.role.merchant':   ["I wonder about prices today.", "Business opportunities are everywhere.", "Have to calculate carefully to turn a profit."] as const,
    'sp.thought.role.scholar':    ["There is so much I still don't understand...", "Knowledge is the one thing no one can take away.", "Are the students making progress?"] as const,
    'sp.thought.role.guard':      ["Order must be maintained.", "Another routine patrol today.", "I heard there was an incident at the market."] as const,
    'sp.thought.role.leader':     ["Every decision has its consequences.", "The burden of responsibility is heavy.", "How can I earn the people's trust?"] as const,
    'sp.thought.role.healthcare': ["So many patients today.", "How can there ever be enough medicine for everyone?", "Public health is declining."] as const,
    'sp.thought.role.gang':       ["You have to seize opportunity when it comes.", "The law belongs to the strong.", "Tonight there's work to be done."] as const,
    'sp.thought.role.child':      ["I wonder who I'll play with today?", "I want to grow up fast so I can do more things.", "Mom, I'm hungry."] as const,
    'sp.thought.role.default':    ["Just another ordinary day."] as const,
    'sp.deceased':       'Deceased',
    'sp.unknown_cause':  'unknown cause',
    'sp.current_activity': 'Current activity',
    'sp.location':         'Location',
    'sp.activity_commute_home':  'Heading home',
    'sp.activity_commute_work':  'Commuting to work',
    'sp.activity_commute_other': 'On the move',
    'sp.act.working':      'Working',
    'sp.act.resting':      'Resting / asleep',
    'sp.act.socializing':  'Socializing',
    'sp.act.family':       'With family',
    'sp.act.organizing':   'Organizing',
    'sp.act.fleeing':      'Fleeing',
    'sp.act.complying':    'Complying (exhausted)',
    'sp.act.confront':     'Confrontation',
    'sp.actions':          'Actions',
    ...
    'sp.has_enemies':     'Enemies (grudges)',
    'sp.personality':     'Personality',
    'sp.personality_greed':      'Greed',
    'sp.personality_aggression': 'Aggression',
    'sp.personality_loyalty':    'Loyalty',
    'sp.personality_ambition':   'Ambition',
    ...
    'engine.strike_settlement': '🤝 The {role} strike ends in a negotiated settlement. Workers return with restored trust.',
    ...
    'engine.opposition.dissent_statement': '📢 The Opposition has published a dissent statement — eroding public trust in the government.',
    'engine.opposition.referendum_triggered': '🗳️ The Opposition calls for a rights referendum — legitimacy {pct}% and pressure is at breaking point.',
    ...
    'engine.gov_payroll_exit': 'A {role} resigned due to unpaid wages and moved into {to} work.',
    'engine.money_printing': '🏦 Treasury crisis: government printed {amount} coins to sustain spending. Inflation now at {inf}%.',
    'engine.public_health.hospital_expired': '🏥 Hospital funding expired — public health infrastructure has lapsed. Renew investment to restore capacity.',
    ...
    'engine.syndicate_formed': '🔪 Organized crime rises: "{name}" syndicate formed with {n} members.',
    'engine.syndicate_bust': '🚔 Crime bust! Guards crack down on "{name}" — {n} members arrested, resources halved.',
    'engine.syndicate_bribe': '💰 "{name}" bribed local officials — public trust in government erodes.',
    'engine.syndicate_racket': '⚠ "{name}" runs a protection racket — {n} merchants shaken down.',
    'engine.syndicate_recruit': '🔪 "{name}" recruited {recruit} into their ranks.',
    'engine.syndicate_dissolved': 'Crime syndicate "{name}" has collapsed.',
    ...
    'role.leader': 'Leader',
    'role.child': 'Child',
    'role.healthcare': 'Healthcare worker',
    'role.gang': 'Gang member',
    ...
    'event.locust_plague': 'Locust Plague',
    'event.festival': 'Festival',
    'event.golden_harvest': 'Golden Harvest',
    'event.cultural_renaissance': 'Cultural Renaissance',
    ...
    'engine.adaptive_role_shift':      '↔ Labor adapts — {n} workers switched careers today ({summary}) in search of better livelihood.',
    ...
    'engine.wealth_invest_research': '🔬 {name} invested {amount} coins in research, accelerating scientific progress.',
    'engine.wealth_invest_infra': '🏗️ {name} funded infrastructure improvements worth {amount} coins — resources more accessible.',
    'engine.wealthy_turned_gang': '⚠️ {name} (formerly {old_role}) used their wealth to establish a criminal enterprise.',
    'engine.guard_patrol_deescalate': '🛡️ {n} guards on patrol — tensions in guarded zones are being suppressed.',
    ...
    'zone.plaza':             'Plaza',
    'zone.clinic_district':   'Clinic & Hospital District',
    'zone.underworld_quarter': 'Underworld Quarter',
    ...
    'occ.child':     ['Child'],
    'occ.healthcare': ['Doctor', 'Nurse', 'Medic', 'Surgeon', 'Pharmacist', 'Midwife'],
    ...
    // Preset descriptions
    'preset.nordic_desc':      'Nordic-model social democracy',
    'preset.cap_desc':         'Liberal market economy',
    'preset.soc_desc':         'Centrally planned economy',
    'preset.feudal_desc':      'Feudal political order',
    'preset.theocracy_desc':   'Theocratic governance',
    'preset.technocracy_desc': 'Technocratic governance',
    'preset.warlord_desc':     'Fragmented warlord rule',
    'preset.commune_desc':     'Egalitarian communal society',
    'preset.marxist_desc':     'State-planned economy, state ownership',
    ...
    'settings.api_locked_nudge':         '⚡ Add an API key to unlock this feature',
    'settings.enabled':                  'Enabled',
    'settings.disabled':                 'Disabled',
    'settings.map_bg.label':             '🗺 Map background',
    'settings.map_bg.desc':              'Town is inset ~10%. Register a painter in code for custom art under the map.',
    'settings.map_bg.background_only':           'Background only',
    'settings.map_bg.background_blurred_layout': 'Background + blurred layout',
    'settings.map_bg.layout_only':                 'Layout only (sharp)',
  ...
  vi: {
    ...
    'setup.preset_nordic': '🏔 Mô hình phúc lợi kiểu Bắc Âu',
    'setup.preset_cap':    '💹 Kinh tế thị trường tự do',
    'setup.preset_soc':    '🏭 Kinh tế kế hoạch hóa tập trung',
    'setup.preset_feudal':      '⚔️ Trật tự chính trị phong kiến',
    'setup.preset_theocracy':   '⛪ Chính thể thần quyền',
    'setup.preset_technocracy': '🧠 Chính thể kỹ trị',
    'setup.preset_warlord':     '🗡 Chính trị quân phiệt',
    'setup.preset_commune':     '🌿 Xã hội công xã bình đẳng',
    'setup.preset_marxist':     '🟥 Kinh tế kế hoạch nhà nước',
    ...
    'econ.exports':     'Xuất khẩu',
    'econ.imports':     'Nhập khẩu',
    'econ.trade_balance': 'Cán cân thương mại',
    'econ.trade_revenue': 'Thu thương mại',
    'econ.money_supply': 'Cung tiền',
    'econ.inflation':   'Lạm phát',
    'econ.money_printed': 'Tiền in thêm',
    'econ.sanitation':  'Vệ sinh công',
    'econ.hospital':    'Bệnh viện',
    'econ.total_taxes': 'Tổng thuế thu',
    'econ.total_printed': 'Tổng tiền đã in',
    'econ.total_exports': 'Tổng xuất khẩu',
    'econ.total_imports': 'Tổng nhập khẩu',
    'econ.total_trade_rev': 'Lũy kế thu thương mại',
    ...
    'econ.tip_exports':    'Giá trị xuất khẩu mỗi ngày từ năng lực sản xuất và trao đổi trong nước.',
    'econ.tip_imports':    'Giá trị nhập khẩu mỗi ngày để bù đắp thiếu hụt hàng hóa/tài nguyên nội địa.',
    'econ.tip_trade_balance': 'Xuất khẩu trừ nhập khẩu. Dương nghĩa là dòng tiền ròng chảy vào từ bên ngoài.',
    'econ.tip_trade_revenue': 'Khoản thu ngân sách từ thuế xuất/nhập và các điều chỉnh dòng tiền thương mại.',
    'econ.tip_money_supply': 'Tổng lượng tiền danh nghĩa lưu hành trong xã hội (tài sản tư nhân + ngân khố).',
    'econ.tip_inflation':  'Áp lực lạm phát tích lũy. Lạm phát cao sẽ làm chi phí sinh hoạt tăng theo thời gian.',
    'econ.tip_money_printed': 'Lượng tiền nhà nước in thêm trong ngày để tránh vỡ ngân sách.',
    'econ.tip_sanitation': 'Chất lượng vệ sinh công cộng (0-100). Tự suy giảm theo thời gian, được cải thiện nhờ y tế/khoa học.',
    'econ.tip_hospital':   'Trạng thái dịch vụ bệnh viện. Chỉ hoạt động khi hạ tầng y tế đang được cấp quỹ.',
    'econ.tip_total_taxes': 'Tổng thuế thu lũy kế từ đầu game (thuế thu nhập, các khoản điều tiết và cống nạp kiểu phong kiến).',
    'econ.tip_total_printed': 'Tổng lượng tiền khẩn cấp mà nhà nước đã in trong toàn bộ ván chơi.',
    'econ.tip_total_exports': 'Giá trị xuất khẩu lũy kế từ lúc bắt đầu.',
    'econ.tip_total_imports': 'Giá trị nhập khẩu lũy kế từ lúc bắt đầu.',
    'econ.tip_total_trade_rev': 'Tổng thu ròng lũy kế của nhà nước từ thuế xuất/nhập và điều chỉnh thương mại.',
    ...
    // Chat
    'chat.ph': 'Nói chuyện với thế giới... ("tạo cơn bão to, mùa màng thuận lợi,...")',
    'chat.disabled': 'Chat AI bị tắt — đang chạy không có API key',
    'chat.ph_no_api': 'Thử: epidemic, drought, storm, festival...',

    // Quick actions
    'qa.aid.label':      '🍞 Cứu trợ',
    'qa.hospital.label': '🏥 Bệnh viện',
    'qa.harvest.label':  '🌾 Trợ cấp',
    'qa.martial.label':  '⚔️ Quân luật',
    'qa.propa.label':    '📢 Tuyên truyền',
    'qa.tax.label':      '💰 Giảm thuế',
    'qa.aid.title':      'Cứu trợ người nghèo',
    'qa.hospital.title': 'Xây bệnh viện',
    'qa.harvest.title':  'Trợ cấp nông nghiệp',
    'qa.martial.title':  'Thiết quân luật',
    'qa.propa.title':    'Tuyên truyền',
    'qa.tax.title':      'Giảm thuế',
    'qa.not_enough':     '— không đủ tiền',
    'qa.feed':           'Hành động: {label}',

    // Factions panel
    'factions.section':       'PHE PHÁI',
    'factions.none':          'Chưa có phe phái',
    'factions.support':       'Hỗ trợ 80💰',
    'factions.suppress':      'Trấn áp',
    'factions.feed_support':  'Hỗ trợ phe {name} ({count} thành viên)',
    ...
    // Objective labels & rewards
    'obj.food.label':     'Giữ lương thực > 50% trong 20 ngày',
    'obj.food.reward':    '+150 coins kho bạc',
    'obj.trust.label':    'Nâng niềm tin lên 40% (hiện {val}%)',
    'obj.trust.reward':   'Legitimacy chính phủ +10%',
    'obj.gini.label':     'Không để Gini vượt 0.70 trong 15 ngày',
    'obj.gini.reward':    'Market trust +10%',
    'obj.pressure.label': 'Giảm bất ổn chính trị xuống 30% (hiện {val}%)',
    'obj.pressure.reward':'Stability +5',
    'obj.literacy.label': 'Đạt literacy 20 (thêm học giả)',
    'obj.literacy.reward':'Research +200 điểm',

    // Crisis cards
    'crisis.food.title':  '⚠️ Nạn đói cận kề',
    'crisis.food.body':   'Lương thực chỉ còn {food}%. Người dân bắt đầu tuyệt vọng.',
    'crisis.food.opt_a':  '🍞 Phân phối khẩu phần (food +10, grievance −)',
    'crisis.food.opt_b':  '🛒 Mua lương thực khẩn (−200 coins, food +20)',
    'crisis.food.opt_c':  '😐 Bỏ mặc (grievance +15)',
    'crisis.epidemic.title':  '🦠 Dịch bệnh lan rộng',
    'crisis.epidemic.body':   'Dịch bệnh đã kéo dài hơn 3 ngày. Cần hành động ngay.',
    'crisis.epidemic.opt_a':  '🚧 Cách ly khu vực (quarantine)',
    'crisis.epidemic.opt_b':  '🏥 Đầu tư y tế (−200 coins, mở bệnh viện)',
    'crisis.epidemic.opt_c':  '🙏 Bỏ qua (fear tăng)',
    'crisis.strike.title':  '✊ Đình công sắp nổ',
    'crisis.strike.body':   'Đoàn kết lao động {unrest}%, bất bình {griev}%. Công nhân chuẩn bị đình công.',
    'crisis.strike.opt_a':  '🤝 Đàm phán (safety_net +0.05, solidarity −20)',
    'crisis.strike.opt_b':  '⚔️ Trấn áp (fear +20, solidarity −30)',
    'crisis.strike.opt_c':  '🤷 Bỏ mặc (đình công tự xảy ra)',
    'crisis.class.title':   '⚖️ Bất ổn giai cấp',
    'crisis.class.body':    'Bất bình đẳng Gini {gini}, ổn định {stability}%. Xã hội đang rạn nứt.',
    'crisis.class.opt_a':   '💸 Tái phân phối (đánh thuế nhà giàu, trao cho nghèo)',
    'crisis.class.opt_b':   '📣 Tuyên truyền (grievance −15, legitimacy +8%)',
    'crisis.class.opt_c':   '🛡️ Tăng cường kiểm soát (guard power +0.2)',
    'crisis.trust.title':   '😤 Khủng hoảng niềm tin',
    'crisis.trust.body':    'Tin tưởng vào chính phủ chỉ còn {trust}%. Chính quyền đang mất tính hợp pháp.',
    'crisis.trust.opt_a':   '📜 Cải cách minh bạch (legitimacy +15%)',
    'crisis.trust.opt_b':   '📺 Truyền thông nhà nước (seed rumor trust_up)',
    'crisis.trust.opt_c':   '🗳️ Bầu cử sớm (trigger referendum)',
    'crisis.trust.rumor':   'Chính phủ đang nỗ lực vì nhân dân',
    'crisis.trust.referendum': 'Tăng phúc lợi để khôi phục niềm tin',

    // Speed warning + no-API chat events
    'speed.ai_warning': '⚡ Tốc độ {speed}× — AI sẽ gọi ~{rpm} req/min. Cân nhắc tắt bớt tính năng AI trong Settings.',
    'noapi.epidemic':   'Dịch bệnh bùng phát ở nhiều khu vực.',
    'noapi.drought':    'Hạn hán kéo dài làm giảm mùa màng.',
    'noapi.storm':      'Bão lớn đổ bộ vào vùng đất.',
    'noapi.festival':   'Lễ hội bắt đầu, tinh thần người dân lên cao.',
    'noapi.harvest':    'Mùa bội thu — kho lương thực đầy ắp.',
    'noapi.scandal':    'Tin tức về tham nhũng lan rộng, niềm tin giảm mạnh.',
    'noapi.refugee':    'Làn sóng người di cư tràn vào vùng đất.',
    'noapi.resource_boom': 'Phát hiện mỏ tài nguyên mới — kinh tế khởi sắc.',
    'noapi.fallback':   '[Chế độ không AI] Thử gõ: "epidemic", "drought", "storm", "festival", "harvest", "scandal", "refugee", "resource boom"',
    ...
    'sp.thought_local.title': 'Tạo cục bộ (AI tắt)',
    'sp.thought.season.spring': 'xuân',
    'sp.thought.season.summer': 'hạ',
    'sp.thought.season.fall':   'thu',
    'sp.thought.season.winter': 'đông',
    'sp.thought.hunger': [
      "Bụng đói quá rồi...",
      "Lâu lắm rồi tôi chưa có một bữa no.",
      "Năm nay mùa {season} mà lương thực vẫn thiếu.",
    ] as const,
    'sp.thought.fear': [
      "Tôi không dám ra ngoài... tình hình nguy hiểm quá.",
      "Nghe nói ngoài kia đang có chuyện lớn.",
      "Mọi người đang trốn đâu hết rồi?",
    ] as const,
    'sp.thought.grievance': [
      "Tôi đã làm việc cả đời mà vẫn không khá hơn được.",
      "Người giàu thì ngày càng giàu, còn người lao động như tôi…",
    ...
    'sp.thought.happy': [
      ...
      "Dành dụm được chút, cảm giác an tâm hơn.",
      "Hôm nay là một ngày tốt.",
    ] as const,
    'sp.thought.role.farmer':     ["Trời hôm nay thế nào nhỉ, mùa màng ra sao?", "Phải cày sớm mới kịp vụ này.", "Đất này năm nào cũng vậy..."] as const,
    'sp.thought.role.craftsman':  ["Đơn hàng ngày hôm nay nhiều hay ít?", "Tay nghề phải luyện mãi mới giỏi được.", "Xưởng hôm nay ồn quá."] as const,
    'sp.thought.role.merchant':   ["Giá cả hôm nay thế nào nhỉ.", "Cơ hội mua bán ở đâu cũng có.", "Phải tính toán cho kỹ mới lời được."] as const,
    'sp.thought.role.scholar':    ["Có bao nhiêu điều chưa hiểu được...", "Tri thức là thứ duy nhất không ai lấy đi được.", "Học trò hôm nay có tiến bộ không?"] as const,
    'sp.thought.role.guard':      ["Trật tự phải được duy trì.", "Hôm nay tuần tra như thường lệ.", "Nghe nói có chuyện ở khu chợ."] as const,
    'sp.thought.role.leader':     ["Quyết định nào cũng có hậu quả của nó.", "Trách nhiệm quá nặng.", "Phải làm sao cho dân tin tưởng hơn."] as const,
    'sp.thought.role.healthcare': ["Bệnh nhân hôm nay nhiều.", "Làm sao có đủ thuốc cho tất cả mọi người?", "Sức khỏe cộng đồng đang xuống."] as const,
    'sp.thought.role.gang':       ["Cơ hội đến thì phải nắm lấy.", "Luật lệ là của kẻ mạnh.", "Tối nay có việc cần làm."] as const,
    'sp.thought.role.child':      ["Hôm nay được chơi với ai nhỉ?", "Muốn lớn nhanh để làm được nhiều thứ hơn.", "Mẹ ơi con đói rồi."] as const,
    'sp.thought.role.default':    ["Một ngày bình thường."] as const,
    'sp.deceased':       'Đã mất',
    'sp.unknown_cause':  'nguyên nhân không rõ',
    'sp.current_activity': 'Hoạt động hiện tại',
    'sp.location':         'Vị trí (trong mô phỏng)',
    'sp.activity_commute_home':  'Đang về nhà',
    'sp.activity_commute_work':  'Đang trên đường đi làm',
    'sp.activity_commute_other': 'Đang di chuyển',
    'sp.act.working':      'Đang làm việc',
    'sp.act.resting':      'Đang nghỉ ngơi / ngủ',
    'sp.act.socializing':  'Đang xã giao',
    'sp.act.family':       'Ở cùng gia đình',
    'sp.act.organizing':   'Đang tổ chức / gắn kết',
    'sp.act.fleeing':      'Đang bỏ chạy',
    'sp.act.complying':    'Đang tuân thủ (kiệt sức)',
    'sp.act.confront':     'Đang đối đầu',
    ...
    'sp.has_enemies':     'Kẻ thù (thù hận)',
    'sp.personality':     'Tính cách',
    'sp.personality_greed':      'Tham lam',
    'sp.personality_aggression': 'Hung hăng',
    'sp.personality_loyalty':    'Trung thành',
    'sp.personality_ambition':   'Tham vọng',
    ...
    'engine.strike_settlement': '🤝 Cuộc đình công của {role} kết thúc bằng thỏa thuận thương lượng. Công nhân trở lại với niềm tin được phục hồi.',
    ...
    'engine.opposition.dissent_statement': '📢 Phe đối lập đã công bố tuyên ngôn phản đối — làm xói mòn niềm tin của công chúng vào chính phủ.',
    'engine.opposition.referendum_triggered': '🗳️ Phe đối lập kêu gọi trưng cầu dân ý về quyền — tính hợp pháp {pct}% và áp lực đang đến điểm giới hạn.',
    ...
    'engine.gov_payroll_exit': 'Một {role} đã nghỉ việc vì thiếu lương và chuyển sang nghề {to}.',
    'engine.money_printing': '🏦 Khủng hoảng ngân khố: chính phủ in thêm {amount} đồng để duy trì chi tiêu. Lạm phát hiện tại {inf}%.',
    'engine.public_health.hospital_expired': '🏥 Ngân sách bệnh viện hết hạn — hạ tầng y tế công cộng đã ngừng hoạt động. Hãy tái đầu tư để khôi phục năng lực.',
    ...
    'engine.syndicate_formed': '🔪 Tội phạm có tổ chức trỗi dậy: băng đảng "{name}" thành lập với {n} thành viên.',
    'engine.syndicate_bust': '🚔 Đột kích băng đảng! Cảnh vệ triệt phá "{name}" — {n} thành viên bị bắt, tài nguyên giảm một nửa.',
    'engine.syndicate_bribe': '💰 "{name}" hối lộ quan chức địa phương — lòng tin vào chính quyền bị xói mòn.',
    'engine.syndicate_racket': '⚠ "{name}" tổ chức tống tiền — {n} thương nhân bị ép buộc nộp tiền bảo kê.',
    'engine.syndicate_recruit': '🔪 "{name}" đã tuyển mộ {recruit} vào hàng ngũ.',
    'engine.syndicate_dissolved': 'Băng đảng "{name}" đã tan rã.',
    ...
    'role.child': 'Trẻ em',
    'role.healthcare': 'Nhân viên y tế',
    'role.gang': 'Thành viên băng đảng',
    // Event type display labels
    'event.storm': 'Bão',
    ...
    'event.heatwave': 'Nắng nóng kỷ lục',
    'event.landslide': 'Sạt lở đất',
    'event.tornado': 'Lốc xoáy',
    'event.locust_plague': 'Châu chấu hoành hành',
    'event.festival': 'Lễ hội',
    'event.golden_harvest': 'Mùa thu hoạch vàng',
    'event.cultural_renaissance': 'Phục hưng văn hóa',
    ...
    'engine.adaptive_role_shift':      '↔ Lao động tự điều tiết — {n} người đổi nghề hôm nay ({summary}) để tìm sinh kế tốt hơn.',
    ...
    'engine.wealth_invest_research': '🔬 {name} đã đầu tư {amount} đồng vào nghiên cứu, thúc đẩy tiến bộ khoa học.',
    'engine.wealth_invest_infra': '🏗️ {name} tài trợ cải thiện hạ tầng trị giá {amount} đồng — tài nguyên được phân phối tốt hơn.',
    'engine.wealthy_turned_gang': '⚠️ {name} (trước đây là {old_role}) dùng tài sản để thành lập một băng đảng.',
    'engine.guard_patrol_deescalate': '🛡️ {n} cảnh vệ đang tuần tra — căng thẳng tại các khu vực có canh gác đang được kiểm soát.',
    ...
    'zone.clinic_district':   'Khu phòng khám & bệnh viện',
    'zone.underworld_quarter': 'Khu thế giới ngầm',
    ...
    'occ.child':     ['Trẻ em'],
    'occ.healthcare': ['Bác sĩ', 'Y tá', 'Y sĩ', 'Phẫu thuật viên', 'Dược sĩ', 'Bà đỡ'],
    'occ.gang':      ['Đòi nợ thuê', 'Kẻ tiêu thụ hàng gian', 'Gác cổng', 'Buôn lậu', 'Đòi thuế đường', 'Đầu gấu'],
    ...
    // Preset descriptions
    'preset.nordic_desc':      'Dân chủ xã hội kiểu Bắc Âu',
    'preset.cap_desc':         'Kinh tế thị trường tự do',
    'preset.soc_desc':         'Kinh tế kế hoạch hóa tập trung',
    'preset.feudal_desc':      'Trật tự chính trị phong kiến',
    'preset.theocracy_desc':   'Chính thể thần quyền',
    'preset.technocracy_desc': 'Chính thể kỹ trị',
    'preset.warlord_desc':     'Chính trị quân phiệt / cát cứ',
    'preset.commune_desc':     'Xã hội công xã bình đẳng',
    'preset.marxist_desc':     'Kinh tế kế hoạch, sở hữu nhà nước',
    ...
    'settings.api_locked_nudge':         '⚡ Thêm API key để kích hoạt tính năng này',
    'settings.enabled':                  'Bật',
    'settings.disabled':                 'Tắt',
    'settings.map_bg.label':             '🗺 Nền bản đồ',
    'settings.map_bg.desc':              'Thị trấn thụt ~10%. Ảnh nền: gắn painter trong code.',
    'settings.map_bg.background_only':           'Chỉ nền',
    'settings.map_bg.background_blurred_layout': 'Nền + layout mờ',
    'settings.map_bg.layout_only':                 'Chỉ layout (nét rõ)',
