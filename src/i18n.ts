const translations = {
  en: {
    ...
    'zone.plaza':               'Plaza',
    'zone.clinic_district':     'Clinic District',
  ...
  vi: {
    ...
    'event.heatwave': 'Sóng nhiệt',
    'event.landslide': 'Sạt lở đất',
    'event.tornado': 'Lốc xoáy',
    'event.locust_plague': 'Nạn châu chấu',
    'event.festival': 'Lễ hội',
    'event.golden_harvest': 'Mùa vàng bội thu',
    ...
    'zone.clinic_district':     'Khu y tế',
    'zone.underworld_quarter':  'Khu ngầm',
