import type { WorldState, NarrativeEntry } from '../../types'
import { clamp, getSeasonFactor } from '../constitution'
import { computeProductivity } from '../npc'
import { autoSurvivalRoleShift } from '../roles'
import { getDiscoveryBonuses } from '../tech'
